...
- **GitHub repository**: <https://github.com/norn-uio/poetry_analysis/>
...
If you discover any bugs, have any questions, or suggestions for improvements, please open an [issue](https://github.com/norn-uio/poetry_analysis/issues) and assign an appropriate label to it. Contributions and pull requests are also welcome!

Please check out the [contributing](https://github.com/norn-uio/poetry_analysis?tab=contributing-ov-file) section in the repo for guidelines.
...
<a href="https://github.com/norn-uio/poetry_analysis">poetry_analysis</a> © 2026 is licensed under
<a href="https://creativecommons.org/licenses/by/4.0/">CC BY 4.0</a>
<img src="https://mirrors.creativecommons.org/presskit/icons/cc.svg" alt="Creative Commons icon" width="20" height="20" style="max-width: 1em;max-height:1em;margin-left: .2em;">
<img src="https://mirrors.creativecommons.org/presskit/icons/by.svg" alt="Attribution icon" width="20" height="20" style="max-width: 1em;max-height:1em;margin-left: .2em;">
